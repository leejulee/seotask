...
class seoInfo {
    ...
    constructor(inputpath, distfile, fileName, rules) {
...
class seoSreamInfo extends seoInfo {
    ...
    constructor(inputpath, distfile, fileName, rules) {
        super(inputpath, distfile, fileName, rules)
...
class seoHelper extends seoHelperbase {
    ...
    createReadStream() {
        return new seoSreamInfo(this.inputpath, this.distfile, this.fileName, this._rules)
    }

    createReadFile() {
        return new seoFileInfo(this.inputpath, this.distfile, this.fileName, this._rules)
    }
}
